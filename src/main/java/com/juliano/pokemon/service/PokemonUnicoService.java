...
public class PokemonUnicoService {
	...
	public ResponseEntity<PokemonUnicoResponse> getPokemonUnicoResponse(Long id) throws NotFoundException {
		PokemonUnico p = Optional.ofNullable(pkuRepository.findById(id).get()).orElseThrow(() -> new NotFoundException("Pokemon inexistente"));
